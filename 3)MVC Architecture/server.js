...
//Saving our document in the database (.save() method

This method returns a promise which is either a resolved one(document will be saved in db)
or error 

callback functions fired for 
reserved one is : .then((doc =>{}))
error is : .catch((error =>{}))
